...
public class TitleBuilder {
    ...
    public TitleBuilder(TitleBuilder titleBuilder) {
        ...
        this.fadeOutTime = -1;
        this.ticks = false;
        this.title = titleBuilder.getTitle();
        this.subtitle = titleBuilder.getSubtitle();
        this.titleColor = titleBuilder.getTitleColor();
        this.subtitleColor = titleBuilder.getSubtitleColor();
        this.fadeInTime = titleBuilder.getFadeInTime();
        this.fadeOutTime = titleBuilder.getFadeOutTime();
        this.stayTime = titleBuilder.getStayTime();
        this.ticks = titleBuilder.isTicks();
        this.loadClasses();
    }
