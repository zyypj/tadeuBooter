package com.github.zyypj.tadeuBooter.minecraft.util;
...
public final class WorldUtils {
    ...
    /**
     * Ativa ou desativa o spawn de mobs em um mundo.
     *
     * @param world Mundo alvo.
     * @param allow Se mobs devem ser permitidos.
     */
    public static void setMobSpawning(World world, boolean allow) {
        world.setGameRuleValue(GameRule.DO_MOB_SPAWNING.toString(), String.valueOf(allow));
    }
