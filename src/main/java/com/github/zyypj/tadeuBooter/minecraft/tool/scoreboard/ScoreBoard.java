package com.github.zyypj.tadeuBooter.minecraft.tool.scoreboard;

import com.github.zyypj.tadeuBooter.minecraft.tool.scoreboard.factory.ScoreBoardBase;
import com.github.zyypj.tadeuBooter.minecraft.tool.scoreboard.factory.ScoreBoardReflection;
...
public class ScoreBoard extends ScoreBoardBase<String> {
    ...
    public void updateTitle(String title) {
        ...
        if (!ScoreBoardBase.VersionType.V1_13.isHigherOrEqual() && title.length() > 32) {
