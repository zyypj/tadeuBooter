package com.github.zyypj.tadeuBooter.api.downloaders.updater;

import com.github.zyypj.tadeuBooter.api.http.client.HttpRequest;
...
public class AutoUpdater {
    ...
    private String getLatestVersion() {
        HttpRequest<String> request = new HttpRequest<>(updateCheckUrl);
        if (request.execute()) {
