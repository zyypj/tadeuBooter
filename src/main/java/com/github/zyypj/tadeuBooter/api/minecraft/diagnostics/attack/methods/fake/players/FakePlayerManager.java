package com.github.zyypj.tadeuBooter.api.minecraft.diagnostics.attack.methods.fake.players;
...
public class FakePlayerManager {
    ...
    public static void createFakePlayer(String name, Location location) {
        ...
        PacketContainer addPlayerPacket = protocolManager.createPacket(PacketType.Play.Server.NAMED_ENTITY_SPAWN);
