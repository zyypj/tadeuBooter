...
public class HttpRequest<T> {
     ...
     */
    public HttpRequest(URL url, int timeoutInMillis) {
        this.url = url;
    ...
    private void buildResponse() throws IOException {
        ...
        this.response = new HttpResponse(raw.toString(), data, responseCode, responseTime, headers, HttpStatus.get(responseCode));
    }
