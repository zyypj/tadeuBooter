package me.zyypj.booter.minecraft.spigot.inventories.viewer.impl.paged;
...
import me.zyypj.booter.minecraft.spigot.inventories.item.enums.DefaultItem;
        ...
        if (this.pageItemList.isEmpty()) {
            ...
            editor.setItem(
                    ...
                    this.hasPreviousPage()
                            ? DefaultItem.PREVIOUS_PAGE.toInventoryItem(this)
                            : null);
        }
    }
