...
public class AnomalyDetectorAI {
    ...
    public static void runDetection(JavaPlugin plugin) {
        ...
        report.append("# ESSA LOG FOI SALVA PELO MRK-CORE\n")
                .append("# INFORMAÇÕES EM DISCORD.GG/MRKK\n\n");
        ...
        if (memoryUsagePercent > MEMORY_USAGE_THRESHOLD) {
            ...
            report.append("Anomaly Detected: High memory usage (")
                    .append(df.format(memoryUsagePercent * 100))
                    .append("% used)\n");
        }
    ...
    private static void saveReport(String reportContent) {
        ...
        try (FileWriter writer = new FileWriter(reportFile)) {
            ...
            Bukkit.getLogger()
                    .info("[AnomalyDetector] Report saved to " + reportFile.getAbsolutePath());
        } catch (IOException e) {
