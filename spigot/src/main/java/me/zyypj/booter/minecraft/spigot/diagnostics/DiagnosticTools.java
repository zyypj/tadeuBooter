package me.zyypj.booter.minecraft.spigot.diagnostics;
...
public class DiagnosticTools {
    ...
    private static final long[] tickTimes = new long[600];
    ...
    public static String getTPS() {
        return "TPS Atual: "
                + df.format(getTPS(100))
                + ", 5 min: "
                + df.format(getTPS(300))
                + ", 15 min: "
                + df.format(getTPS(600));
    }
    ...
    public static String getMemoryUsage() {
        ...
        return String.format(
                "Memória Usada: %d MB, Disponível: %d MB, Máximo: %d MB",
    ...
    public static String getSystemInfo() {
        ...
        return String.format(
                "Sistema: %s %s, Núcleos: %d, Load Average: %.2f",
                osBean.getName(),
                osBean.getVersion(),
