package me.zyypj.booter.minecraft.spigot.scoreboard;
...
public class ScoreBoard extends ScoreBoardBase<String> {
    ...
    static {
        try {
            ...
            MESSAGE_FROM_STRING =
                    lookup.unreflect(craftChatMessageClass.getMethod("fromString", String.class));
    ...
    /**
     * Atualiza o título do ScoreBoard, verificando o tamanho da string em versões inferiores a
     * 1.13.
     *
    ...
    public void updateTitle(String title) {
        ...
        if (!ScoreBoardBase.VersionType.V1_13.isHigherOrEqual(VersionType.V1_13)
                && title.length() > 32) {
            ...
            for (String s : lines) {
                if (s != null && s.length() > 30) {
                    throw new IllegalArgumentException(
                            "Line " + lineCount + " is longer than 30 chars");
                }
                lineCount++;
            }
        }
    ...
    /**
     * Converte e divide uma linha para envio, tratando prefixo e sufixo para evitar quebra de
     * códigos de cor.
     *
    ...
    protected void sendLineChange(int score) throws Throwable {
        // Define o tamanho máximo com base na versão: em versões antigas, há limite de 16, caso
        // contrário 1024.
    ...
    /**
     * Indica se há limite de caracteres para prefixo/sufixo, retornando true para versões
     * inferiores a 1.13 (1.12 ou abaixo).
     *
