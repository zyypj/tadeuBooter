...
public final class ClickEvent implements Examinable, StyleBuilderApplicable {
  ...
  public static ClickEvent callback(@NotNull ClickCallback<Audience> function) {
    return ClickCallbackInternals.PROVIDER.create(Objects.<ClickCallback<Audience>>requireNonNull(function, "function"), ClickCallbackOptionsImpl.DEFAULT);
  }
  
  @NotNull
  public static ClickEvent callback(@NotNull ClickCallback<Audience> function, ClickCallback.Options options) {
    return ClickCallbackInternals.PROVIDER.create(Objects.<ClickCallback<Audience>>requireNonNull(function, "function"), Objects.<ClickCallback.Options>requireNonNull(options, "options"));
  }
  ...
  public static ClickEvent callback(@NotNull ClickCallback<Audience> function, @NotNull Consumer<ClickCallback.Options.Builder> optionsBuilder) {
    return ClickCallbackInternals.PROVIDER.create(
        Objects.<ClickCallback<Audience>>requireNonNull(function, "function"), 
        (ClickCallback.Options)AbstractBuilder.configureAndBuild(ClickCallback.Options.builder(), Objects.<Consumer>requireNonNull(optionsBuilder, "optionsBuilder")));
  }
  ...
  private ClickEvent(@NotNull Action action, @NotNull String value) {
    this.action = Objects.<Action>requireNonNull(action, "action");
