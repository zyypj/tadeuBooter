    ...
    void doSetRate(double permitsPerSecond, double stableIntervalMicros) {
      ...
      if (oldMaxPermits == Double.POSITIVE_INFINITY) {
        ...
        this
          ...
          .storedPermits = (oldMaxPermits == 0.0D) ? this.maxPermits : (this.storedPermits * this.maxPermits / oldMaxPermits);
      } 
    }
    ...
    void doSetRate(double permitsPerSecond, double stableIntervalMicros) {
      ...
      if (oldMaxPermits == Double.POSITIVE_INFINITY) {
        ...
        this
          ...
          .storedPermits = (oldMaxPermits == 0.0D) ? 0.0D : (this.storedPermits * this.maxPermits / oldMaxPermits);
      } 
    }
