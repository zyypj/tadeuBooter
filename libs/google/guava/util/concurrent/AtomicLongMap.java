...
public final class AtomicLongMap<K> implements Serializable {
  ...
  public long updateAndGet(K key, LongUnaryOperator updaterFunction) {
    ...
    Long result = this.map.compute(key, (k, value) -> Long.valueOf(updaterFunction.applyAsLong((value == null) ? 0L : value.longValue())));
    return ((Long)Objects.<Long>requireNonNull(result)).longValue();
  }
  ...
  long putIfAbsent(K key, long newValue) {
    ...
    return noValue.get() ? 0L : ((Long)Objects.<Long>requireNonNull(result)).longValue();
  }
