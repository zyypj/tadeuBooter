  ...
  private static ThreadFactory doBuild(ThreadFactoryBuilder builder) {
    ...
    return new ThreadFactory() {
        public Thread newThread(Runnable runnable) {
          ...
          if (nameFormat != null)
            thread.setName(ThreadFactoryBuilder.format(nameFormat, new Object[] { Long.valueOf(((AtomicLong)Objects.<AtomicLong>requireNonNull(this.val$count)).getAndIncrement()) })); 
          if (daemon != null)
