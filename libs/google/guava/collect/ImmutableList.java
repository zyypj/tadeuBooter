  ...
  static <E> ImmutableList<E> asImmutableList(Object[] elements, int length) {
    ...
    switch (length) {
      case 0:
        return of();
      case 1:
        onlyElement = Objects.requireNonNull((E)elements[0]);
        return of(onlyElement);
    } 
    Object[] elementsWithoutTrailingNulls = (length < elements.length) ? Arrays.<Object>copyOf(elements, length) : elements;
