...
import me.syncwrld.booter.libs.google.guava.base.Converter;
...
public final class Maps {
  ...
  public static <K extends Enum<K>, V> ImmutableMap<K, V> immutableEnumMap(Map<K, ? extends V> map) {
    ...
    Enum enum_ = (Enum)entry1.getKey();
    V value1 = entry1.getValue();
    CollectPreconditions.checkEntryNotNull(enum_, value1);
    EnumMap<K, V> enumMap = new EnumMap<>(Collections.singletonMap((K)enum_, value1));
