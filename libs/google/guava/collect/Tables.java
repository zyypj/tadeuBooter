...
public final class Tables {
  ...
  private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
    ...
    Iterator<Table.Cell<C, R, V>> cellIterator() {
      return Iterators.transform(this.original
          .cellSet().iterator(), TRANSPOSE_CELL);
    }
    
    Spliterator<Table.Cell<C, R, V>> cellSpliterator() {
      return CollectSpliterators.map(this.original
          .cellSet().spliterator(), (Function<?, ? extends Table.Cell<C, R, V>>)TRANSPOSE_CELL);
    }
  }
