...
public final class Multimaps {
  ...
  private static class CustomMultimap<K, V> extends AbstractMapBasedMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
      ...
      this.factory = (Supplier<? extends Collection<V>>)Objects.<Object>requireNonNull(stream.readObject());
      Map<K, Collection<V>> map = (Map<K, Collection<V>>)Objects.<Object>requireNonNull(stream.readObject());
      setMap(map);
    }
  }
  ...
  private static class CustomListMultimap<K, V> extends AbstractListMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
      stream.defaultReadObject();
      this.factory = (Supplier<? extends List<V>>)Objects.<Object>requireNonNull(stream.readObject());
      Map<K, Collection<V>> map = (Map<K, Collection<V>>)Objects.<Object>requireNonNull(stream.readObject());
      setMap(map);
    }
  }
  ...
  private static class CustomSetMultimap<K, V> extends AbstractSetMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
      stream.defaultReadObject();
      this.factory = (Supplier<? extends Set<V>>)Objects.<Object>requireNonNull(stream.readObject());
      Map<K, Collection<V>> map = (Map<K, Collection<V>>)Objects.<Object>requireNonNull(stream.readObject());
      setMap(map);
    }
  }
  ...
  private static class CustomSortedSetMultimap<K, V> extends AbstractSortedSetMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
      stream.defaultReadObject();
      this.factory = (Supplier<? extends SortedSet<V>>)Objects.<Object>requireNonNull(stream.readObject());
      ...
      if (result == null)
        result = this.map = Collections.<K, V>unmodifiableMap(
            Maps.transformValues(this.delegate
              .asMap(), collection -> Multimaps.unmodifiableValueCollection(collection))); 
      return result;
    }
          ...
          public Iterator<V> iterator() {
            return new Iterator<V>() {
                ...
                public V next() {
                  ...
                  this.i++;
                  return NullnessCasts.uncheckedCastNullableTToT((V)Multimaps.MapMultimap.this.map.get(key));
                }
  ...
  private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
    ...
    Map<K, Collection<V2>> createAsMap() {
      return Maps.transformEntries(this.fromMultimap.asMap(), (key, value) -> transform((K)key, value));
    }
  ...
  static class Keys<K, V> extends AbstractMultiset<K> {
    ...
    Iterator<Multiset.Entry<K>> entryIterator() {
      return new TransformedIterator<Map.Entry<K, Collection<V>>, Multiset.Entry<K>>(this, this.multimap
  ...
  static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
    ...
    class EntrySet extends Maps.EntrySet<K, Collection<V>> {
      ...
      public Iterator<Map.Entry<K, Collection<V>>> iterator() {
        return Maps.asMapEntryIterator(Multimaps.AsMap.this.multimap.keySet(), key -> Multimaps.AsMap.this.multimap.get(key));
      }
      
      public boolean remove(@CheckForNull Object o) {
        if (!contains(o))
          return false; 
        Map.Entry<?, ?> entry = Objects.<Map.Entry<?, ?>>requireNonNull((Map.Entry<?, ?>)o);
