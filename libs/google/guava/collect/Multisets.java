...
public final class Multisets {
  ...
  static final class MultisetIteratorImpl<E> implements Iterator<E> {
    ...
    public E next() {
      ...
      this.laterCount--;
      this.canRemove = true;
      return ((Multiset.Entry<E>)Objects.<Multiset.Entry<E>>requireNonNull(this.currentEntry)).getElement();
    }
    ...
    public void remove() {
      ...
      if (this.totalCount == 1) {
        ...
        this.multiset.remove(((Multiset.Entry)Objects.<Multiset.Entry>requireNonNull(this.currentEntry)).getElement());
      } 
      this.totalCount--;
  ...
  public static <E> ImmutableMultiset<E> copyHighestCountFirst(Multiset<E> multiset) {
    ...
    Arrays.sort(arrayOfEntry, (Comparator)DecreasingCount.INSTANCE);
