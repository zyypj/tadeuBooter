...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
  ...
  private static long codePointToFourUtf8Bytes(int codePoint) {
    return 0xF0L | (codePoint >>> 18) | (0x80L | (0x3F & codePoint >>> 12)) << 8L | (0x80L | (0x3F & codePoint >>> 6)) << 16L | (0x80L | (0x3F & codePoint)) << 24L;
  }
  
  private static long charToThreeUtf8Bytes(char c) {
    return 0xE0L | (c >>> 12) | ((0x80 | 0x3F & c >>> 6) << 8) | ((0x80 | 0x3F & c) << 16);
  }
  
  private static long charToTwoUtf8Bytes(char c) {
    return 0xC0L | (c >>> 6) | ((0x80 | 0x3F & c) << 8);
  }
}
