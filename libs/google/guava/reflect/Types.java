...
import me.syncwrld.booter.libs.google.guava.collect.Iterables;
...
final class Types {
  ...
  private enum ClassOwnership {
    ...
    private static ClassOwnership detectJvmBehavior() {
      ...
      ParameterizedType parameterizedType = Objects.<ParameterizedType>requireNonNull((ParameterizedType)subclass.getGenericSuperclass());
  ...
  private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
    ...
    public String toString() {
      ...
      Objects.requireNonNull(Types.JavaVersion.CURRENT);
      return builder.append(this.rawType.getName()).append('<').append(Types.COMMA_JOINER.join(Iterables.transform((Iterable)this.argumentsList, Types.JavaVersion.CURRENT::typeName)))
        .append('>')
        .toString();
    }
  ...
  static final class WildcardTypeImpl implements WildcardType, Serializable {
    ...
    public String toString() {
      StringBuilder builder = new StringBuilder("?");
      for (UnmodifiableIterator<Type> unmodifiableIterator = this.lowerBounds.iterator(); unmodifiableIterator.hasNext(); ) {
        Type lowerBound = unmodifiableIterator.next();
  ...
  private static Type[] toArray(Collection<Type> types) {
    return types.<Type>toArray(new Type[0]);
  }
