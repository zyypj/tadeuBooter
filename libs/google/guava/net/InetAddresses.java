...
import me.syncwrld.booter.libs.google.guava.hash.Hashing;
import me.syncwrld.booter.libs.google.guava.io.ByteStreams;
...
public final class InetAddresses {
  ...
  public static String toAddrString(InetAddress ip) {
    ...
    if (ip instanceof Inet4Address)
      return Objects.<String>requireNonNull(ip.getHostAddress()); 
