package me.syncwrld.booter.libs.google.guava.net;
...
import me.syncwrld.booter.libs.google.guava.base.CharMatcher;
import me.syncwrld.booter.libs.google.guava.base.Charsets;
...
import me.syncwrld.booter.libs.google.guava.collect.ImmutableListMultimap;
import me.syncwrld.booter.libs.google.guava.collect.ImmutableMultiset;
import me.syncwrld.booter.libs.google.guava.collect.ImmutableSet;
import me.syncwrld.booter.libs.google.guava.collect.ListMultimap;
...
public final class MediaType {
  ...
  private String computeToString() {
    ...
    if (!this.parameters.isEmpty()) {
      builder.append("; ");
      ListMultimap listMultimap = Multimaps.transformValues((ListMultimap)this.parameters, value -> 
          
          (TOKEN_MATCHER.matchesAllOf(value) && !value.isEmpty()) ? value : escapeAndQuote(value));
