...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
  ...
  public LinkedTreeMap(Comparator<? super K> comparator, boolean allowNullValues) {
    this
      ...
      .comparator = (comparator != null) ? comparator : (Comparator)NATURAL_ORDER;
  ...
  static final class Node<K, V> implements Map.Entry<K, V> {
    ...
    public boolean equals(Object o) {
      if (o instanceof Map.Entry) {
        ...
        return (((this.key == null) ? (other.getKey() == null) : this.key.equals(other.getKey())) && ((this.value == null) ? (other
          .getValue() == null) : this.value.equals(other.getValue())));
      } 
      return false;
    }
