...
import me.syncwrld.booter.libs.javassist.CtPrimitiveType;
...
public class JvstCodeGen extends MemberCodeGen {
  ...
  public void atMember(Member mem) throws CompileError {
    ...
    if (name.equals(this.paramArrayName)) {
      ...
      this.bytecode.addInvokestatic("me/syncwrld/booter/libs/javassist/runtime/Desc", "getParams", "(Ljava/lang/String;)[Ljava/lang/Class;");
      this.exprType = 307;
      this.arrayDim = 1;
  ...
  private void callGetType(String method) {
    this.bytecode.addInvokestatic("me/syncwrld/booter/libs/javassist/runtime/Desc", method, "(Ljava/lang/String;)Ljava/lang/Class;");
    this.exprType = 307;
    this.arrayDim = 0;
    this.className = "java/lang/Class";
  }
  ...
  protected void atCflow(ASTList cname) throws CompileError {
    ...
    this.bytecode.addGetstatic((String)names[0], (String)names[1], "Lme/syncwrld/booter/libs/javassist/runtime/Cflow;");
    this.bytecode.addInvokevirtual("me.syncwrld.booter.libs.javassist.runtime.Cflow", "value", "()I");
    this.exprType = 324;
    this.arrayDim = 0;
    this.className = null;
  }
