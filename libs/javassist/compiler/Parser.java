    ...
    while (true) {
      ...
      switch (this.lex.lookAhead()) {
        ...
        case 46:
          ...
          t = this.lex.get();
          if (t == 307) {
            aSTree1 = parseDotClass((ASTree)expr2, 0);
            continue;
          } 
          if (t == 336) {
            expr1 = Expr.make(46, (ASTree)new Symbol(toClassName(aSTree1)), (ASTree)new Keyword(t));
            continue;
          } 
          if (t == 400) {
        ...
        case 35:
          ...
          expr1 = Expr.make(35, (ASTree)new Symbol(toClassName((ASTree)expr1)), (ASTree)new Member(str));
          continue;
      } 
      break;
    } 
  ...
  private ASTree parseDotClass(int builtinType, int dim) throws CompileError {
    ...
    switch (builtinType) {
      case 301:
        ...
        return (ASTree)Expr.make(35, (ASTree)new Symbol(cname), (ASTree)new Member("TYPE"));
      case 303:
