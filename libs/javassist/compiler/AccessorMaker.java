...
import me.syncwrld.booter.libs.javassist.bytecode.SyntheticAttribute;
...
public class AccessorMaker {
  ...
  static final String lastParamType = "me.syncwrld.booter.libs.javassist.runtime.Inner";
  ...
  public String getConstructor(CtClass c, String desc, MethodInfo orig) throws CompileError {
    ...
    if (consDesc != null)
      return consDesc; 
    consDesc = Descriptor.appendParameter("me.syncwrld.booter.libs.javassist.runtime.Inner", desc);
