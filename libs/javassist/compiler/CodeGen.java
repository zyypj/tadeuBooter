...
import me.syncwrld.booter.libs.javassist.compiler.ast.ASTree;
import me.syncwrld.booter.libs.javassist.compiler.ast.ArrayInit;
import me.syncwrld.booter.libs.javassist.compiler.ast.AssignExpr;
import me.syncwrld.booter.libs.javassist.compiler.ast.BinExpr;
import me.syncwrld.booter.libs.javassist.compiler.ast.CallExpr;
import me.syncwrld.booter.libs.javassist.compiler.ast.CastExpr;
import me.syncwrld.booter.libs.javassist.compiler.ast.CondExpr;
import me.syncwrld.booter.libs.javassist.compiler.ast.Declarator;
import me.syncwrld.booter.libs.javassist.compiler.ast.DoubleConst;
import me.syncwrld.booter.libs.javassist.compiler.ast.Expr;
import me.syncwrld.booter.libs.javassist.compiler.ast.FieldDecl;
import me.syncwrld.booter.libs.javassist.compiler.ast.InstanceOfExpr;
import me.syncwrld.booter.libs.javassist.compiler.ast.IntConst;
import me.syncwrld.booter.libs.javassist.compiler.ast.Keyword;
import me.syncwrld.booter.libs.javassist.compiler.ast.Member;
import me.syncwrld.booter.libs.javassist.compiler.ast.MethodDecl;
import me.syncwrld.booter.libs.javassist.compiler.ast.NewExpr;
import me.syncwrld.booter.libs.javassist.compiler.ast.Pair;
import me.syncwrld.booter.libs.javassist.compiler.ast.Stmnt;
import me.syncwrld.booter.libs.javassist.compiler.ast.StringL;
import me.syncwrld.booter.libs.javassist.compiler.ast.Symbol;
import me.syncwrld.booter.libs.javassist.compiler.ast.Variable;
import me.syncwrld.booter.libs.javassist.compiler.ast.Visitor;
...
public abstract class CodeGen extends Visitor implements Opcode, TokenId {
  ...
  protected void patchGoto(List<Integer> list, int targetPc) {
    for (Iterator<Integer> iterator = list.iterator(); iterator.hasNext(); ) {
      int pc = ((Integer)iterator.next()).intValue();
  ...
  private void atSwitchStmnt(Stmnt st) throws CompileError {
    ...
    for (Stmnt stmnt1 = body; stmnt1 != null; aSTList = stmnt1.tail()) {
      ASTList aSTList;
      if (((Stmnt)stmnt1.head()).getOperator() == 304)
        npairs++; 
    } 
    ...
    for (Iterator<Integer> iterator = gotoDefaults.iterator(); iterator.hasNext(); ) {
      int addr = ((Integer)iterator.next()).intValue();
  ...
  protected void atClassObject2(String cname) throws CompileError {
    ...
    this.bytecode.addInvokestatic("me.syncwrld.booter.libs.javassist.runtime.DotClass", "fail", "(Ljava/lang/ClassNotFoundException;)Ljava/lang/NoClassDefFoundError;");
    this.bytecode.addOpcode(191);
    this.bytecode.write16bit(pc, this.bytecode.currentPc() - pc + 1);
  }
