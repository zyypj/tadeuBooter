...
import me.syncwrld.booter.libs.javassist.bytecode.DuplicateMemberException;
import me.syncwrld.booter.libs.javassist.bytecode.ExceptionsAttribute;
import me.syncwrld.booter.libs.javassist.bytecode.FieldInfo;
import me.syncwrld.booter.libs.javassist.bytecode.MethodInfo;
import me.syncwrld.booter.libs.javassist.bytecode.SignatureAttribute;
import me.syncwrld.booter.libs.javassist.bytecode.StackMapTable;
...
public class ProxyFactory {
  ...
  private static final String NULL_INTERCEPTOR_HOLDER = "me.syncwrld.booter.libs.javassist.util.proxy.RuntimeSupport";
  ...
  private Class<?> getClassInTheSamePackage() {
    if (this.basename.startsWith("me.syncwrld.booter.libs.javassist.util.proxy."))
      return getClass(); 
  ...
  private static final String packageForJavaBase = "me.syncwrld.booter.libs.javassist.util.proxy.";
  ...
  private void checkClassAndSuperName() {
    ...
    if (this.basename.startsWith("java.") || this.basename.startsWith("jdk.") || onlyPublicMethods)
      this.basename = "me.syncwrld.booter.libs.javassist.util.proxy." + this.basename.replace('.', '_'); 
  }
  ...
  private static MethodInfo makeConstructor(String thisClassName, Constructor<?> cons, ConstPool cp, Class<?> superClass, boolean doHandlerInit) {
    ...
    code.addAload(0);
    code.addGetstatic("me.syncwrld.booter.libs.javassist.util.proxy.RuntimeSupport", "default_interceptor", HANDLER_TYPE);
    code.addPutfield(thisClassName, "handler", HANDLER_TYPE);
  ...
  private static MethodInfo makeWriteReplace(ConstPool cp) {
    ...
    code.addAload(0);
    code.addInvokestatic("me.syncwrld.booter.libs.javassist.util.proxy.RuntimeSupport", "makeSerializedProxy", "(Ljava/lang/Object;)Ljavassist/util/proxy/SerializedProxy;");
    code.addOpcode(176);
    minfo.setCodeAttribute(code.toCodeAttribute());
    return minfo;
  }
