...
import me.syncwrld.booter.libs.javassist.bytecode.stackmap.BasicBlock;
    ...
    this
      ...
      .basicBlocks = (Block[])(new BasicBlock.Maker() {
        ...
        protected BasicBlock[] makeArray(int size) {
          return (BasicBlock[])new ControlFlow.Block[size];
        }
      }).make(minfo);
