...
import me.syncwrld.booter.libs.javassist.bytecode.LineNumberAttribute;
import me.syncwrld.booter.libs.javassist.bytecode.LocalVariableAttribute;
import me.syncwrld.booter.libs.javassist.bytecode.LocalVariableTypeAttribute;
...
import me.syncwrld.booter.libs.javassist.bytecode.StackMap;
...
public abstract class CtBehavior extends CtMember {
  ...
  static void setBody0(CtClass srcClass, MethodInfo srcInfo, CtClass destClass, MethodInfo destInfo, ClassMap map) throws CannotCompileException {
    ...
    } catch (me.syncwrld.booter.libs.javassist.bytecode.CodeAttribute.RuntimeCopyException e) {
      throw new CannotCompileException(e);
    } 
  ...
  public void useCflow(String name) throws CannotCompileException {
    ...
    try {
      CtClass type = pool.get("me.syncwrld.booter.libs.javassist.runtime.Cflow");
