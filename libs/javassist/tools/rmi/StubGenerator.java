...
import me.syncwrld.booter.libs.javassist.CtNewConstructor;
...
public class StubGenerator implements Translator {
  ...
  private static final String sampleClass = "me.syncwrld.booter.libs.javassist.tools.rmi.Sample";
  ...
  public void start(ClassPool pool) throws NotFoundException {
    this.classPool = pool;
    CtClass c = pool.get("me.syncwrld.booter.libs.javassist.tools.rmi.Sample");
    this.forwardMethod = c.getDeclaredMethod("forward");
    this.forwardStaticMethod = c.getDeclaredMethod("forwardStatic");
    this
      .proxyConstructorParamTypes = pool.get(new String[] { "me.syncwrld.booter.libs.javassist.tools.rmi.ObjectImporter", "int" });
    this
      .interfacesForProxy = pool.get(new String[] { "java.io.Serializable", "me.syncwrld.booter.libs.javassist.tools.rmi.Proxy" });
    this
      .exceptionForProxy = new CtClass[] { pool.get("me.syncwrld.booter.libs.javassist.tools.rmi.RemoteException") };
  }
  ...
  private CtClass produceProxyClass(CtClass orgclass, Class<?> orgRtClass) throws CannotCompileException, NotFoundException {
    ...
    CtField f = new CtField(this.classPool.get("me.syncwrld.booter.libs.javassist.tools.rmi.ObjectImporter"), "importer", proxy);
    f.setModifiers(2);
