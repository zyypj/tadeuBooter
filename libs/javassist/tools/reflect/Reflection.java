...
import me.syncwrld.booter.libs.javassist.CodeConverter;
...
import me.syncwrld.booter.libs.javassist.Translator;
...
public class Reflection implements Translator {
  ...
  static final String metaobjectClassName = "me.syncwrld.booter.libs.javassist.tools.reflect.Metaobject";
  
  static final String classMetaobjectClassName = "me.syncwrld.booter.libs.javassist.tools.reflect.ClassMetaobject";
  ...
  public void start(ClassPool pool) throws NotFoundException {
    this.classPool = pool;
    String msg = "me.syncwrld.booter.libs.javassist.tools.reflect.Sample is not found or broken.";
    try {
      CtClass c = this.classPool.get("me.syncwrld.booter.libs.javassist.tools.reflect.Sample");
      ...
      throw new RuntimeException("me.syncwrld.booter.libs.javassist.tools.reflect.Sample is not found or broken.");
    } catch (BadBytecode e) {
      throw new RuntimeException("me.syncwrld.booter.libs.javassist.tools.reflect.Sample is not found or broken.");
    } 
  }
  ...
  public boolean makeReflective(CtClass clazz, CtClass metaobject, CtClass metaclass) throws CannotCompileException, CannotReflectException, NotFoundException {
    if (clazz.isInterface())
      throw new CannotReflectException("Cannot reflect an interface: " + clazz
          .getName()); 
    if (clazz.subclassOf(this.classPool.get("me.syncwrld.booter.libs.javassist.tools.reflect.ClassMetaobject")))
      throw new CannotReflectException("Cannot reflect a subclass of ClassMetaobject: " + clazz
          
          .getName()); 
    if (clazz.subclassOf(this.classPool.get("me.syncwrld.booter.libs.javassist.tools.reflect.Metaobject")))
  ...
  private boolean modifyClassfile(CtClass clazz, CtClass metaobject, CtClass metaclass) throws CannotCompileException, NotFoundException {
    ...
    CtClass mlevel = this.classPool.get("me.syncwrld.booter.libs.javassist.tools.reflect.Metalevel");
    ...
    processFields(clazz);
    if (addMeta) {
      CtField ctField = new CtField(this.classPool.get("me.syncwrld.booter.libs.javassist.tools.reflect.Metaobject"), "_metaobject", clazz);
    ...
    CtField f = new CtField(this.classPool.get("me.syncwrld.booter.libs.javassist.tools.reflect.ClassMetaobject"), "_classobject", clazz);
    f.setModifiers(10);
