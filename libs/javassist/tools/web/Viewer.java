package me.syncwrld.booter.libs.javassist.tools.web;
...
public class Viewer extends ClassLoader {
  ...
  protected Class<?> findClass(String name) throws ClassNotFoundException {
    Class<?> c = null;
    if (name.startsWith("java.") || name.startsWith("me.syncwrld.booter.libs.javax.") || name
      .equals("me.syncwrld.booter.libs.javassist.tools.web.Viewer"))
